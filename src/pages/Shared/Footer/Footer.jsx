...
const Footer = () => {
  ...
  return (
    <div className=" m-5 ">
      <footer className="footer p-10 col-auto mt-3 text-base-content text-white-100 uppercase">
        <div>
        <img src={LearningMain} alt="" className="w-10 rounded-full" />

          <h2 className="uppercase text-2xl">Learning Language.</h2>
          <p className="uppercase">
          Learning Language Start-2020
          </p>
          {year}
        </div>
        <div>
        ...
        <div>
          <span className="footer-title">Learning Language</span>
          <a className="link link-hover">About Learning Language</a>
      ...
      <div>
        <div className="footer-center p-4 bg-neutral text-neutral-content">
          <div>
            <div className=" footer-center ml-80 items-center">
              <div className="text-base-content  grid-flow-col flex gap-4">
          ...
          <div>
            <p>
              Copyright © {year} - All right Learning Language
            </p>
          </div>
        </div>
      </div>
